...
echo "<h1><a href='".$linkadd1."'>CLICK HERE TO UPADTE YOUR PASSWORD </a></h1>";
echo "</br>";
echo "</br>";
echo "</br>";
echo "<h1><a href='".$linkadd2."'>CLICK HERE TO VIEW THE LIST OF RECIPENTS</a></h1>";
}
$conn->close(); 
?>
...
<h1>WELCOME TO CARING MADE EASY</h1>
</div>
